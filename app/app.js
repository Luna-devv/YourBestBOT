...
const { API42_UID, API42_SECRET, PORT } = require("../config.json");
const app = express();
const intra = require("../src/Commands/dev/intra");
...
app.get('/user/:user', addDate, (req, res) => {

	let data = {}

	//console.log(intra);

	//req.params.user = intra.User;
	console.log("intra.User: " + intra.User)
...
app.listen(PORT, () => {
	...
	req.send(`grant_type=client_credentials&client_id=${API42_UID}&client_secret=${API42_SECRET}`);
